...
st.set_page_config(page_title='ANÁLISE MICRO', page_icon=':page_with_curl:', layout='wide') 
    
with st.sidebar:
    st.header('Análise Micro', divider='rainbow')
    st.image('360_F_677599597_XwaNr1HI6sNvHMlYL6rzvSd3HIK8SqHO.JPG')
    st.divider()
...
with st.container():
    ...
    st.header('Tabela de Dados Intraday:', divider='rainbow')
